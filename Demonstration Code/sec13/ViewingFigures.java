...
public class ViewingFigures 
{
	...
	public static void main(String[] args)
	{
		...
		// Step 7 - convert to ratios
//		JavaPairRDD<Integer, Double> step7 = step6.mapToPair(row -> new Tuple2<>(row._1, (double) row._2._1 / row._2._2));
		...
		// Step 11 - drop courseId, and sort by score
